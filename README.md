### :rocket: Project: सब local
    सब local is a webapp developed for connecting local shops to their regular customers by online
...
### :clipboard: Work-flow: 
    ...
    Shop owners dash board -> Editing of offers etc. info -> Deque feature -> Message to customer feature
...
### :pushpin: Note:
    ...
    b) Message facility will not be available from 9 AM to 9 PM.
